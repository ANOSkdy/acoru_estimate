...
export const ESTIMATE_PRESETS: EstimatePreset[] = [
  ...
  },
  {
    id: 'ai-chatbot',
    label: 'AIチャットボット',
    description: 'FAQ応答・問い合わせ一次対応・履歴管理を含むチャット導入構成。',
    suggestedProjectName: 'AIチャットボット導入',
    scores: { screen: 10, feature: 14, operation: 8 },
    note: '回答品質改善のため、運用フェーズでプロンプト調整工数を見込んでください。',
  },
  {
    id: 'rag-ai-docs',
    label: 'RAG AI（資料管理）',
    description: '社内資料取り込み・検索・回答生成を行うナレッジ活用基盤。',
    suggestedProjectName: 'RAG AI（資料管理）構築',
    scores: { screen: 12, feature: 20, operation: 11 },
    note: 'ドキュメント更新頻度とアクセス権限要件の確認が初期見積の精度に影響します。',
  },
  {
    id: 'ai-call-center',
    label: 'AIコールセンター',
    description: '音声一次対応・要約・オペレーター連携を想定した高度運用型。',
    suggestedProjectName: 'AIコールセンター構築',
    scores: { screen: 14, feature: 24, operation: 16 },
    note: '通話品質要件、エスカレーション設計、音声基盤連携の有無で大きく変動します。',
  },
  {
